...
//    (openssl rand -base64 32) on bash to create jwtsecret key
...
// logout function codebase--------------
export async function logout(req,res){
    res.clearCookie("jwt");
    res.status(200).json({success:true,message:"Logout successful"});
}

// onboarding user after signup--
